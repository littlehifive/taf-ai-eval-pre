...
knitr::include_graphics("images/ai-eval-framework.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.height=7.5, fig.align="center"}
knitr::include_graphics("images/l1-framework.png")
```
...
**Resources**: [AI4GD A/B Testing Playbook](https://docs.google.com/document/d/1_i1LjHIA3MHBCez1gxvSqZohN9zkwjG09h5L2k4BryQ/edit?tab=t.0#heading=h.wdgt1uho9q75), [AI4GD User Funnel and Metrics Playbook](https://docs.google.com/document/u/0/d/18OFMLI70IZLQuwhuxTwZXrDhw6Z-kpT-QUqZZJugEZ4/edit)
